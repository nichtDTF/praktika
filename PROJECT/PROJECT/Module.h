...
void move_into(int*, int*);			//перемещение отсутствующих чисел в изначальном массиве в отдельный	массив
void output(int*);					//вывод отсутствующих чисел
int  find(int* massiv, int*, int*);	//поиск отсутствующих чисел
